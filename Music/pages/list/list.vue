...
<style scoped>
	...
	.list-head-img{ width: 260rpx; height: 260rpx; border-radius: 30rpx; overflow: hidden; position: relative; margin-right: 42rpx;}
	...
	.list-share{width: 330rpx; height: 70rpx; margin: 0 auto; background: rgba(0,0,0,0.4);border-radius: 73rpx;color: white; text-align: center;
				font-size: 28rpx; line-height: 74rpx;}
	.list-share text{margin-right: 16rpx;}
	
	.list-music{background: white; border-radius: 50rpx; margin-top: 40rpx; overflow: hidden;}
	.list-music-head{ height: 50rpx; margin-left: 22rpx; margin-top: 30rpx;margin-bottom: 70rpx; }
	...
	.list-music-item{display: flex; margin: 0 32rpx 60rpx 46rpx;align-items: center;color: #959595;}
	.list-music-top{width: 58rpx; font-size: 30rpx; line-height: 50rpx;}
	.list-music-song{flex: 1;line-height: 40rpx;}
	.list-music-song view:nth-child(1){font-size: 28rpx; color: black; width: 70vw; white-space: normal; overflow: hidden; text-overflow: ellipsis;}
	.list-music-song view:nth-child(2){ font-size: 20rpx; align-items: center;width: 70vw; white-space: normal; overflow: hidden; text-overflow: ellipsis;}
	.list-music-song view:nth-child(2) image{height: 20rpx;width: 32rpx; margin-right: 10rpx;}
