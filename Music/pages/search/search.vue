		...
		<view class="container">
			<scroll-view scroll-y="true" >
				<view class="index-search">
					...
					<text class="iconfont iconguanbi" @tap="handleToDel" v-show="searchWord != ''"></text>
				</view>
				<block v-if="searchType ==1">
					...
					<view class="search-history">
						<view class="search-history-head">
							<text>历史记录</text>
							<text class="iconfont iconlajitong" @tap="handleToClean"></text>
						</view>	
	...
	export default {
		...
		methods: {
			...
			handleToSearch(word){
				...
				this.searchHistory = [...new Set(this.searchHistory)] //去重
...
<style scoped>
	...
	.search-hot{margin: 0 30rpx; font-size: 26rpx;margin-top: 50rpx;}
	...
	.search-result-item{display: flex;justify-content: space-between;align-items: center;border-bottom: 2rpx solid #e4e4e4;padding-bottom: 30rpx;
	margin-bottom: 30rpx;}
	.search-result-word{}
	...
	.search-suggest{border-top: 2rpx solid #e4e4e4;padding: 30rpx; font-size: 26rpx;}
